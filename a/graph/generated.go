...
func (ec *executionContext) _Query_animals(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOAnimal2ᚕᚖmainᚋgraphᚋmodelᚐAnimalᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOAnimal2ᚕᚖmainᚋgraphᚋmodelᚐAnimalᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Animal) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNAnimal2ᚖmainᚋgraphᚋmodelᚐAnimal(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
