...
type ComplexityRoot struct {
	...
	Entity struct {
		FindAnimalByID func(childComplexity int, id string) int
	}
...
type EntityResolver interface {
	FindAnimalByID(ctx context.Context, id string) (*model.Animal, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Animal.hello":
		if e.complexity.Animal.Hello == nil {
			break
		}

		return e.complexity.Animal.Hello(childComplexity), true
	...
	case "Entity.findAnimalByID":
		if e.complexity.Entity.FindAnimalByID == nil {
			break
		}

		args, err := ec.field_Entity_findAnimalByID_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Entity.FindAnimalByID(childComplexity, args["id"].(string)), true
...
union _Entity = Animal

# fake type to build resolver interfaces for users to implement
type Entity {
	findAnimalByID(id: String!,): Animal!
}
...
func (ec *executionContext) field_Entity_findAnimalByID_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	arg0, err := ec.field_Entity_findAnimalByID_argsID(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["id"] = arg0
...
func (ec *executionContext) field_Entity_findAnimalByID_argsID(
	ctx context.Context,
...
func (ec *executionContext) _Animal_hello(ctx context.Context, field graphql.CollectedField, obj *model.Animal) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Animal_hello(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_Animal_hello(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Animal",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _Entity_findAnimalByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Entity_findAnimalByID(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Entity().FindAnimalByID(rctx, fc.Args["id"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNAnimal2ᚖmainᚋgraphᚋmodelᚐAnimal(ctx, field.Selections, res)
}

func (ec *executionContext) fieldContext_Entity_findAnimalByID(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Entity",
		Field:      field,
		IsMethod:   true,
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "hello":
				return ec.fieldContext_Animal_hello(ctx, field)
			}
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Entity_findAnimalByID_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
var animalImplementors = []string{"Animal", "_Entity"}
...
func (ec *executionContext) _Animal(ctx context.Context, sel ast.SelectionSet, obj *model.Animal) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "hello":
			out.Values[i] = ec._Animal_hello(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		default:
	...
	for i, field := range fields {
		...
		case "findAnimalByID":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Entity_findAnimalByID(ctx, field)
				if res == graphql.Null {
...
func (ec *executionContext) marshalNAnimal2ᚖmainᚋgraphᚋmodelᚐAnimal(ctx context.Context, sel ast.SelectionSet, v *model.Animal) graphql.Marshaler {
	if v == nil {
